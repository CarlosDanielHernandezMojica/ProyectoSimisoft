...
public class frmUsuarios extends javax.swing.JInternalFrame {
    ...
    private void bBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarActionPerformed
        if (txtBuscar.getText().isEmpty() == false) {
            System.out.println(usuario.Search(txtBuscar.getText()).getRowCount());

            if(usuario.Search(txtBuscar.getText()).getRowCount() > 0){
                jtUsuarios.setModel(usuario.Search(txtBuscar.getText()));
            }else{
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        if(txtBuscar.getText().isEmpty()){
            jtUsuarios.setModel(usuario.GetAllModelNew());
        }
