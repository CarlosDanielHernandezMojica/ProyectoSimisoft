...
public class frmUsuarios extends javax.swing.JInternalFrame {
    ...
    public frmUsuarios() {
        initComponents();
        jtUsuarios.setModel(new Usuarios().GetAllModelNew());

        for (int i = 0; i < usuario.GetAllModel().getColumnCount(); i++) {
            cbColumna.addItem(usuario.GetAllModel().getColumnName(i).toString());
        }
    ...
    private void initComponents() {
        ...
        tUsuarios = new javax.swing.JScrollPane();
        ...
        tUsuarios.setViewportView(jtUsuarios);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tUsuarios, javax.swing.GroupLayout.DEFAULT_SIZE, 684, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(tUsuarios, javax.swing.GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE))
        );
    ...
    private void bModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bModificarActionPerformed
        if (jtUsuarios.getSelectedRow() >= 0) {
            int idProducto = (int) jtUsuarios.getValueAt(jtUsuarios.getSelectedRow(), 0);
            frmNUsuario obj = new frmNUsuario(idProducto);
            obj.setTitle("Modificar Usuaio");
            obj.setModal(true);
            obj.setVisible(true);
            jtUsuarios.setModel(new Usuarios().GetAllModelNew());
    ...
    private void bOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bOrdenarActionPerformed
        jtUsuarios.setModel(usuario.GetAllOrderBy());
    ...
    private void cbColumnaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbColumnaItemStateChanged
        ...
        for (int i = 0; i < usuario.GetAllModel().getRowCount(); i++) {

            cbBusqueda.addItem(usuario.GetAllModel().getValueAt(i, selected).toString());
    ...
    private void bBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBuscarActionPerformed
        jtUsuarios.setModel(usuario.Search(cbColumna.getSelectedItem().toString(), cbBusqueda.getSelectedItem().toString()));
    ...
    private void bEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarActionPerformed
        if (jtUsuarios.getSelectedRow() >= 0) {
            if (JOptionPane.showConfirmDialog(this, "¿Desea eliminar este elemento?", "Eliminar", JOptionPane.YES_NO_OPTION) < 1) {
                ...
                obj.setIdUsuario(idProducto);
                if (obj.Delete()) {
                    JOptionPane.showMessageDialog(this, "Producto eliminado");
                }
                jtUsuarios.setModel(obj.GetAllModel());
            }
    ...
    private void bActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizarActionPerformed
        Usuarios obj = new Usuarios();
        jtUsuarios.setModel(obj.GetAllModelNew());
    ...
    private javax.swing.JScrollPane tUsuarios;
